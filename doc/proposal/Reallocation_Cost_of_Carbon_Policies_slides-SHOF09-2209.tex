...
\begin{frame}{Literature and Contribution}
	\begin{itemize}
		...
		\begin{itemize}
			\item Contribution: \textbf{Quantify substitution between green and brown capital}\\
			\citep{martinsson2024effect,shapiro2018pollution,ahmadi2022carbon,andersson2019carbon} 
		\end{itemize}
		\pause
		\item Misallocation
		\begin{itemize}
			\item Contribution: \textbf{Misallocation (Reallocation) in the context of environmental policies}\\
			\citep{whited2021misallocation,hsieh2009misallocation,ai2020financial,asker2014dynamic}
		\end{itemize}
		\pause
		\item Climate Policy Design
		\begin{itemize}
			\item Contribution: \textbf{Assess alternative instruments in Emission Intensity / resource reallocation}\\
			\cite{acemoglu2012competing,acemoglu2016transition,oehmke2023theory}
		\end{itemize}
	\end{itemize}
...
\begin{frame}{Extension}{Production functions}\label{Production_Functions}
	...
	\begin{itemize}\footnotesize
		...
		\item $\alpha_s$: importance of Green capital in the production
		\item $\gamma_s$: elasticity of substitution between Green and Brown capital
		\item $\tilde{A}_{si}$: emission intensity
...
\begin{frame}{Emission and Production}{{Counterfactual}}\label{emission_production}
	\begin{figure}[http]
		\centering
		\only<1>{\includegraphics[width=.65\textwidth]{Figures/emission_production_1.pdf}}
		\only<2>{\includegraphics[width=.65\textwidth]{Figures/emission_production_2.pdf}}
		\only<3>{\includegraphics[width=.65\textwidth]{Figures/emission_production_3.pdf}}
		\only<4->{\includegraphics[width=.65\textwidth]{Figures/emission_production.pdf}}
	\end{figure}
	\hfill
	\only<1>{\hyperlink{estimation_result}{\beamerbutton{Estimation/Calibration}}}
