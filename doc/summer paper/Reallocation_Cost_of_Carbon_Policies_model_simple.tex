...
\begin{enumerate}
    ...
    \begin{align*}
        &= \frac{- \sigma_s}{\hat{A}_{si}p_i} z_L^{\beta} \left[
            ((\frac{r}{z_l} + w)\beta-\frac{r}{z_l} )\frac{1-\alpha}{\triangle}\dfrac{\tilde{A}}{r^\beta+\tau_E \tilde{A}}
            + \gamma \frac{\beta}{1-\beta}\frac{\alpha(1-\alpha)}{\circ\triangle}\dfrac{\tilde{A}}{r^\beta+\tau_E \tilde{A}} 
            - \gamma \frac{\beta}{1-\beta}\frac{\alpha(1-\alpha)}{\circ\triangle}\dfrac{\tilde{A}}{r^\beta+\tau_E \tilde{A}}
        \right]\\
