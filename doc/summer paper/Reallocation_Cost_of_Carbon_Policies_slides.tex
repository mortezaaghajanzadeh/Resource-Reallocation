...
\begin{frame}{Emission and Production}{Results}\label{emission_production}
	...
	{\begin{figure}[http]
		...
		\only<2>{\includegraphics[width=.6\textwidth]{Figures/emission_production_2_1.pdf}}
		\only<3>{\includegraphics[width=.6\textwidth]{Figures/emission_production_2_2.pdf}}
		\only<4>{\includegraphics[width=.6\textwidth]{Figures/emission_production_2_3.pdf}}
		\only<5>{\includegraphics[width=.6\textwidth]{Figures/emission_production_3.pdf}}
	\end{figure}}
